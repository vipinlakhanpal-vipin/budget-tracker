...
<div className="field" style={isMobile ? { flex: '1 1 0', minWidth: 0 } : { flex: '0 1 170px', minWidth: 150 }}>
        ...
        >
          ...
          {activePanel === 'help' && (() => {
            ...
            const HELP_LAST_UPDATED_VERSION = '3.20';
            const helpTopics = [
{ key: 'updates', title: "What's New", body: <>Latest updates (Aug 5, 2026): Aria's icon now has a small animated flourish -- every so often it fades out in a brief firecracker-style spark burst, followed by a cheerful animated smiley for about 2 seconds, before the icon reappears and resumes its normal float. A friendly greeting message ("Hey, I'm Aria. Happy to help, whenever you're ready") now shows next to the icon on desktop. Also fixed two mojibake display glitches in the currency picker -- Curaçao and São Tomé & Príncipe now render correctly.</> },
