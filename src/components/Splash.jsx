...
const PLATFORM_ICON_RADIUS = 104;
            ...
            {PLATFORM_TABS.map((tab, i) => {
              ...
              return (
                ...
                (() => {
                  ...
                  return (
                    <g key={tab.label} transform={`translate(${pos.x - 12} ${pos.y - 28})`}>
                      <g className="platform-tab-icon" transform="scale(1.2)" style={{ animationDelay: `${0.7 + i * 0.09}s` }}>
                        ...
                        {isTwoLine ? (
                          <text textAnchor="middle" className="platform-tab-label">
                            <tspan x="12" y="34">{words[0]}</tspan>
                            <tspan x="12" y="49">{words.slice(1).join(' ')}</tspan>
                          </text>
                        ) : (
                          <text x="12" y="37" textAnchor="middle" className="platform-tab-label">{tab.label}</text>
                        )}
                      </g>
                    </g>
                  );
