...
const MANUAL_TOPICS = [
  {
    "key": "updates",
    "title": "What's New",
    "body": "Latest updates (Aug 10, 2026): Hearth now has Free and Paid group account plans -- Free includes Income, Regular Expenses, and Reports; Paid adds Fixed Expenses, Savings, Investments, and Aria. A locked section shows a short \"Premium feature\" prompt linking to Support. You can now delete your own account from Settings \u203a App \u203a Account, and there's now a Terms of Service alongside the Privacy Policy in the footer and in Settings. The footer's \"Suggestion\" link is now \"Support\" -- pick a topic tag or two and describe what's going on, and it goes straight to the app owner. The 10 dashboard summary tiles (Monthly Budget through My Investments) each get their own subtle color now instead of one flat surface. On desktop, Income, Fixed Expenses, Regular Expenses, Savings, and Investments have a thin left rail (Add/View/Charts) so you see one thing at a time instead of everything stacked at once, and picking Charts now shows it at full width instead of a narrow side column. Mobile has the same Add/View/Charts switcher as pills at the top of each section. The top tab bar (Dashboard through Help) is one rounded pill capsule instead of separate solid buttons,  The Admin Console's Households tab is now called Group Accounts and shows each group's member emails so admins can tell accounts apart at a glance."
  },
  {
    "key": "home",
    "title": "Dashboard",
